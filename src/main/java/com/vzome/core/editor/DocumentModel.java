...
import static com.vzome.core.editor.ManifestationColorMappers.getRegisteredMapperName;
...
public class DocumentModel implements Snapshot .Recorder, UndoableEdit .Context, Tool .Registry
{
	...
	private MapColors getColorMapper(String mapperName, String symmetrySystemName) {
        SymmetrySystem symmName = symmetrySystems.get(symmetrySystemName);
        ManifestationColorMapper colorMapper
                = mapperName.equals(getRegisteredMapperName(SystemColorMap.class)) ? new SystemColorMap(symmName)
                : mapperName.equals(getRegisteredMapperName(SystemCentroidColorMap.class)) ? new SystemCentroidColorMap(symmName)
                : mapperName.equals(getRegisteredMapperName(NearestSpecialOrbitColorMap.class)) ? new NearestSpecialOrbitColorMap(symmName)
                : mapperName.equals(getRegisteredMapperName(CentroidNearestSpecialOrbitColorMap.class)) ? new CentroidNearestSpecialOrbitColorMap(symmName)
